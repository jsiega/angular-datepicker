...
(function(angular){
/* global moment */
var Module = angular.module('opw-datepicker', []);
...
Module.directive('opw-datepicker', ['datePickerConfig', 'datePickerUtils', function datePickerDirective(datePickerConfig, datePickerUtils) {
    ...
    link: function (scope, element, attrs, ngModel) {
      ...
      function setDate(date) {
        ...
        if (scope.callbackOnSetDate) {
          scope.callbackOnSetDate(attrs.opw-datepicker, scope.date);
        }
      }
...
angular.module('opw-datepicker').factory('datePickerUtils', function () {
var tz;
...
angular.module('opw-datepicker').run(['$templateCache', function($templateCache) {
